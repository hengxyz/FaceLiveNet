...
def main(args):
    ...
    #dataset = facenet_ext.get_dataset(args.input_dir)
    ...
    threshold = [0.3, 0.4, 0.4]  # three steps's threshold
    ...
    with open(bounding_boxes_filename, "w") as text_file:
        ...
        for image_path in image_paths:
            ...
            output_filename = os.path.join(args.output_dir, filename + '.jpg')
            print(image_path)
            if not os.path.exists(output_filename):
                try:
                    ...
                    if img.ndim < 2:
                        ...
                        continue
                    if img.ndim == 2:
                        img = facenet_ext.to_rgb(img)
                    img = img[:, :, 0:3]

                    bounding_boxes, landmarks = detect_face.detect_face(img, minsize, pnet, rnet, onet, threshold,
                                                                        factor)
...
def parse_arguments(argv):
    ...
    parser.add_argument('--input_dir', type=str, help='Directory with unaligned images.', default='/data/zming/GH/face_recognition/data/face_samples-20191225T141159Z-001/face_samples/reference_mtcnn_original')
    parser.add_argument('--output_dir', type=str, help='Directory with aligned face thumbnails.', default='/data/zming/GH/face_recognition/data/face_samples-20191225T141159Z-001/face_samples/reference_mtcnn')
